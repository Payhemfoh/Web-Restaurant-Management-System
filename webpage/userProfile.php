...
<html lang="en">
    <head>
        <title>RMS | Edit User Profile</title>
        <?php 
    ...
    <body class="bg-light">
        ...
        <div id="content" class="container bg-light col-md-9 rounded">
            <form>
                <fieldset>
                    <br><h3 class="text-center">Edit User Profile</h3><br>
                    ...
                    <?php
                        ...
                        if ($sess_position == "staff")
                        {
                            echo "<div class='form-group'>";
                            echo "<label for = 'position_id'><b>Position id:</b></label>";
                            echo "<input type = 'number' id = 'position_id' name = 'position_id'>";
                   ...
                   ?>
                    ...
                    <input type = "submit" class="btn btn-block btn-primaryLight btn-primary" value = "EDIT" id="btn_edit">
        ...
        <?php
            ...
            if($sess_position == "staff")
            {
                echo "<script type='module' src='../javascript/staffManagementModule_script.js'></script>";
            }
            else
            {
                echo "<script type='module' src='../javascript/customerManagementModule_script.js'></script>";
            }
        ?>
    </body>
</html>