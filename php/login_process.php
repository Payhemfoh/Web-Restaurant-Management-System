<?php
    ...
    if($valid)
    {
        ...
        $statement->bind_param("s",$username,$password);
        $statement->execute();
        ...
        if($found){
            ...
            echo "Failed to login! Click the button below to try again.";
            echo "<button class=\"btn btn-block btn-lg btn-outline-primary\">Try Again</button>";
        }
    }
?>